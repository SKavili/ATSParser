...
- If no explicit designation is found, return Other.
...
Output (JSON only, no other text, no explanations):"""
            ...
            if designation is not None:
                ...
                if not designation or designation.lower() in ["null", "none", ""]:
                    designation = None
                    logger.warning("Designation was empty/null after cleaning")
                    print(f"⚠️  Designation was empty/null after cleaning")
