...
class ResumeMetadata(Base):
    ...
    pinecone_status = Column(Integer, nullable=True, server_default="0")  # IT/Non-IT index: 0 = not indexed, 1 = indexed
    ats_pinecone_status_all = Column(
        Integer, nullable=True, server_default="0"
    )  # Pinecone `ats` index (all): 0 = not indexed, 1 = indexed
